...
onEvent('item.registry', event => {
	...
	while (true) {
		...
		simple("Weathered Limestone", "Обветренный известняк", CR('weathered_limestone', 16), 3, S, 0x5E6055, 0x797E74)
		simple("Dolomite", "Доломит", CR('dolomite', 16), 3, S, 0xC2C2C2, 0xDADADA)
		simple("Gabbro", "Габбро", CR('gabbro', 16), 3, S, 0x6B5D4F, 0x7D6B5A)
		simple("Scoria", "Пепел", CR('scoria', 16), 3, S, 0x2A130C, 0x553427)
		simple("Dark Scoria", "Тёмный пепел", CR('dark_scoria', 16), 3, S, 0x0D0706, 0x23201A)
		...
		simple("Copper Ingot", "Медный слиток", CR('copper_ingot', 8), 16, S, 0xDD7E5D, 0xFCEFBA)
		...
		simple("Mangrove Root", "Мангровый корень", BOP('mangrove_root', 4), 9, S, 0x795740, 0xB8AB88)
		...
		simple("Architect's Limestone", "Известняк", AP('limestone', 32), 8, S, 0x756958, 0x7F7360)
		...
		simple("Guardian Spike", "Шип стража", RQ('guardian_spike', 1), 2, G, 0x7F4215, 0xE29964)
